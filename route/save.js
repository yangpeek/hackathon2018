module.exports = {
    ...
    sendResponse: function(res, obj, fileParams) {
      let content = "Saved to: " + fileParams[0] + "/" + fileParams[1] + "*" + "." + fileParams[2] + " content:<br/>" + JSON.stringify(obj) + '<script>setTimeout(function() {window.location.href = "http://127.0.0.1:8088/edit?dir=config&prefix=config&ext=json";}, 10000);</script>;';
